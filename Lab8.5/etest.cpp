...
int main() {
  ...
  std::cout << r.valid << " " << r.value << std::endl;
...
0.29552
1.41421
ERROR Boolean of value false thrown
ERROR Invalid argument
libc++abi.dylib: terminating with uncaught exception of type char const*  <<<< to moze wygladac inaczej
